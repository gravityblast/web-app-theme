require "spec_helper"
require "generators/web_app_theme/themed/themed_generator"

describe WebAppTheme::ThemedGenerator do

  context "for post/posts" do
    before do
      Post = Class.new
    ...
    it "should set the right controller_routing_path" do
      @generator.send(:controller_routing_path).should == "posts"
    end
    ...
    it "should set the right model_name" do
      @generator.send(:model_name).should == "Post"
    end
  ...
  context "for admin/gallery_items" do
    before do
    ...
    it "should set the right controller_routing_path" do
      @generator.send(:controller_routing_path).should == "admin_gallery_items"
    end
    ...
    it "should set the right model_name" do
      @generator.send(:model_name).should == "GalleryItem"
    end
  ...
  context "for admin/gallery_items pictures" do
    before do
      Picture = Class.new
    ...
    it "should set the right model_name" do
      @generator.send(:model_name).should == "Picture"
    end
